...
const GameComponent: React.FC<GameComponentProps> = ({ playerName, roomId, onExitGame }) => {
  ...
  useEffect(() => {
    ...
    const handlePlayerDeath = () => {
      console.log("플레이어 사망 이벤트 감지: UI 표시");
  ...
  const handleRespawn = () => {
    ...
    console.log("리스폰 버튼 클릭: 리스폰 처리 시작");
